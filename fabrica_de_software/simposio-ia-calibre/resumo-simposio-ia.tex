...
Dra.~Kerlla de Souza Luz\footnote{E-mail: \texttt{kerlla.luz@udf.edu.br}}\par}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{assets/problema-distribuicao-commits.png}
\caption{Distribuição do número de \textit{commits} por participante no
LabTech/UDF, evidenciando forte assimetria de contribuição
(mediana~$\approx$~23; amplitude 0--49) --- difícil de avaliar sem
instrumentação contínua.}
\par\vspace{2pt}{\footnotesize Fonte: os autores (2026), a partir de dados de repositórios do LabTech/UDF.\par}
\label{fig:problema}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.62\textwidth]{assets/analise-ia-membro.png}
\caption{Módulo de análise por IA (Google Gemini) do \textit{dashboard}: resumo
em linguagem natural das contribuições (\textit{issues}) de um membro de equipe,
gerado automaticamente para apoiar a leitura docente.}
\par\vspace{2pt}{\footnotesize Fonte: os autores (2026) --- \textit{dashboard} em produção.\par}
\label{fig:ia}
\end{figure}
