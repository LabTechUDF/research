...
\textbf{Organização dos artefatos}: o próximo passo é estruturar um repositório \textbf{open source} com licença \textbf{GPL3} contendo:
\begin{itemize}
...
\textbf{Pilotos}: iniciar \textbf{testes-piloto} após organização do repositório, com protocolo de avaliação (usabilidade, utilidade, aderência).
