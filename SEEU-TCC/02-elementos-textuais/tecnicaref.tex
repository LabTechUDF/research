...
% Nota: o detalhamento sobre o scraper do STF foi movido para
% `02-elementos-textuais/scraper.tex` para que a coleta de dados possa ser
% apresentada como seção dedicada no Capítulo~\ref{chap:metodologia}.
