...
\begin{figure}[H]
	...
	\vspace*{0,2cm}
    \includegraphics[width=0.75\textwidth]{./04-figuras/navegar_abnt}
...
\begin{figure}[H]
	...
	\vspace*{0,2cm}
    \includegraphics[width=0.45\textwidth]{./04-figuras/abnt.png}
    \caption{Exemplo de figura}
    \label{fig:abnt}
\end{figure}
\vspace*{-1,5cm}
